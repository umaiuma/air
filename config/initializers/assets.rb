...
Rails.application.config.assets.precompile += %w( levels_chart.css )
Rails.application.config.assets.precompile += %w( levels_list.js )
Rails.application.config.assets.precompile += %w( levels_chart.js )
Rails.application.config.assets.precompile += %w( problems.scss )
